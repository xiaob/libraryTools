...
public class Dialog_ProgressActivity1 extends BaseActivity {
    ...
    public static void startAction(Context context) {
        new RxActivityOptionsTool().setContext(context)
                .setClass(Dialog_ProgressActivity1.class)
                .customAnim()
                .start();
    }
    ...
    private QuickAdapter functionadapter;
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        functionadapter=new QuickAdapter();
        ...
        //添加Header
        View header = LayoutInflater.from(this).inflate(R.layout.activity_toast_lables, toastRecyclerview, false);

        LabelsView toastLabels= (LabelsView) header;
        ...
        functionadapter.addHeaderView(toastLabels);
        functionadapter.openLoadAnimation(BaseQuickAdapter.SCALEIN);

        functionadapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            @Override
    ...
    public class QuickAdapter extends BaseQuickAdapter<FunctionBean, BaseViewHolder> {
        public QuickAdapter() {
            super(R.layout.activity_toast_spink);
        }
