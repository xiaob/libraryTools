...
import com.veni.rxtools.RxImageTool;
import com.veni.rxtools.RxKeyboardTool;
...
public class RxTitle extends FrameLayout {
    ...
    private void initView(final Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mTitleSize = a.getDimensionPixelSize(R.styleable.RxTitle_titleSize, RxImageTool.dp2px(context,20));//标题字体大小
            ...
            mLeftIcon = a.getResourceId(R.styleable.RxTitle_leftIcon, R.drawable.icon_previous);//左边图标
            ...
            mLeftTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_leftTextSize,  RxImageTool.dp2px(context,8));//标题字体大小
            ...
            mRightTextSize = a.getDimensionPixelSize(R.styleable.RxTitle_rightTextSize,  RxImageTool.dp2px(context,8));//标题字体大小
