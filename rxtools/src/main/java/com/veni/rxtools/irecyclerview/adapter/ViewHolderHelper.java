...
import com.veni.rxtools.view.imageload.RxImageLoaderTool;
...
public class ViewHolderHelper extends RecyclerView.ViewHolder {
    ...
    public ViewHolderHelper setImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        RxImageLoaderTool.display(mContext,view,url);
        return this;
    }
    public ViewHolderHelper setBigImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        RxImageLoaderTool.displayBigPhoto(mContext,view,url);
        return this;
    }
    public ViewHolderHelper setSmallImageUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        RxImageLoaderTool.displaySmallPhoto(mContext,view,url);
        return this;
    }
    public ViewHolderHelper setImageRoundUrl(int viewId, String url) {
        ImageView view = getView(viewId);
        RxImageLoaderTool.displayCircle(mContext,view,url);
        return this;
    }
     ...
     * 关于事件的
     */
    public ViewHolderHelper setOnClickListener(int viewId, OnNoFastClickListener listener) {
        View view = getView(viewId);
