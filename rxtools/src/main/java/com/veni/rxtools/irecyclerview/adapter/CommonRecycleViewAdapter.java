...
import com.veni.rxtools.irecyclerview.DataIO;
import com.veni.rxtools.irecyclerview.animation.AlphaInAnimation;
import com.veni.rxtools.irecyclerview.animation.BaseAnimation;
import com.veni.rxtools.irecyclerview.bean.PageBean;

import java.util.ArrayList;
import java.util.List;

/**
 * 基于RecycleView的万能Adapter
 * @param <T>
 */
public abstract class CommonRecycleViewAdapter<T> extends RecyclerView.Adapter<ViewHolderHelper> implements DataIO<T> {
    ...
    protected void setListener(final ViewGroup parent, final ViewHolderHelper viewHolder, int viewType) {
        ...
        viewHolder.getConvertView().setOnClickListener(new OnNoFastClickListener() {
            @Override
            protected void onNoDoubleClick(View view) {

                if (mOnItemClickListener != null) {
                    int dataposition = getPosition(viewHolder);
                    mOnItemClickListener.onItemClick(parent, view, mDatas.get(dataposition), dataposition);
                }
            }
        });
